...
| `z8000` | Zilog Z8000 ファミリ (Z8001/Z8002/Z8003/Z8004) | **公開済** — DLL ビルド + リリース同梱 |
...
の GitHub Release に zip / インストーラとして同梱されます。「設計ノート
のみ」「ヘッダのみ」の行は、ディレクトリ構造に違和感を持たせないために
明記しているもので、GitHub Release にこれらの DLL は **含まれません**。
